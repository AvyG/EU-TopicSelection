...
```
The compartion text by text is as follows

- Text1 (2022 Speech): it belong solely to the Topic 3 category which main words are "us", "today", "ukraine", "market", "time", "future", "war","new" "democracy", "good". Compared to the main topics extracted from the website (EU support for Ukraine, overcoming the energy crisis, climate, rule of law, democracy, support for European enterprises) there is a clear similarity mainly in ideas like ukraine and democracy but essential topics like climate, law and energy are missing from the bag of words that better represent this text. Therefore some of the characterization of this speech is missing from our model.

-Text2 (2021 Speech): it belong to multiple categories, 82% of the speech words belong to the Topic 5 ("new", "time", "global", "world", "good", "value",  "work", "people", "together", "us") and 18% belong to the Topic 10 ("market", "investment", "freedom", "level", "common", "crisis", "defend", "work", "end", "euro"). Compared to the main topics extracted from the website (COVID-19, global health, vaccination, stronger Europe in the world, European Chips Act, European Defence Union, rule of law and media freedom) gives the impression that Topic 5 represent the the pandemic topic in a more cooperative setting and the Topic 10 focus on the investment planed for Europe. However there are still main ideas that are missing from the representative bag of words like law and media. 

- Text3 (2020 Speech): it belong to multiple categories, 30% of the speech words belong to the Topic 2 ("people", "new", "get", "support", "global", "us", "way", "opportunity", "show", "take"), 49% of the word speech belongs to Topic 6 ("world", "us", "work". "want", "good", "time", "together", "datum", "change", "build") and 21% of the words belong to Topic 9 ("just", "first", "world", "energy", "life", "always", "new", "global", "show", "us"). Compared to the main topics extracted from the website (COVID-19 pandemic, NextGenerationEU, European Health Union, Industrial Strategy, Europe’s Digital Decade, New European Bauhaus) the results are insatisfactory. The only words from the topic selection of our model that are related to the main themes of the speech have an indirect relationship with the pandemic ideas, words like "global", "together" and "support". So we conclude that the model did not perfomed well identifying  the main topics of this speech.    

- Text4 (2018 Speech): it belong to multiple categories, 23% of the words of the speech belong to the Topic 13 ("good", "work", "solidarity", "right", "long", "love", "new", "2019", "always", "day") and 77% of the speech's words belong to Topic 16 ("one", "time", "world", "come", "want", "today", "unite", "us", "border", "speak"). Compared with the main topics extracted from the website (migration, cybersecurity and foreign policy) 

- Text5 (2017 Speech): it belong to multiple categories, 39% of the words of the speech belong to the Topic 12, 7% of the words belong to the Topic 13 and  
...
We would like to dedicate this last part of this section to discuss the shortcomings of our methodology.

- We would like to start by addressing the cleaning issues the mention during section 4. Words like "us" have a ambiguous meaning since it could be the pronoun us of the acronym US (as the country) lowercase. As one can see these two uses are completely different 

- We only search for k nor for alpha 

- We iterated the fitting process of the LDA model 10 times 

- Also, to address the validation process of our model more seriously, it is ideal to use more models such as 
