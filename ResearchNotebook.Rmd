...
We would like to start with some descriptive analysis of the speech. First we use a cloud of words foe each speech to see what are the most common words.
...
for (i in 1:nrow(df)){
  ...
  lda <- dfm_matrix %>% convert(to = "topicmodels") %>% 
         LDA(k=5, control = list(seed=0, alpha=1))
